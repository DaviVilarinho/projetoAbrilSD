...
public enum MosquittoTopics {
    CLIENT_CREATION_TOPIC("client/creation", (topic, message) -> {
        DatabaseService databaseService = DatabaseService.getInstance();
        System.out.println("Mensagem recebida de " + topic + ": " + message.toString());
        ClientGRPC clientGRPC = null;
        try {
            clientGRPC = (ClientGRPC) new ObjectInputStream(new ByteArrayInputStream(message.getPayload())).readObject();
        } catch (IOException e) {
    ...
    }), CLIENT_UPDATE_TOPIC("client/update", (topic, message) -> {
        DatabaseService databaseService = DatabaseService.getInstance();
        System.out.println("Mensagem recebida de " + topic + ": " + message.toString());
        ClientGRPC clientGRPC = null;
        try {
        ...
        databaseService.listAll();
    }), CLIENT_DELETION_TOPIC("client/deletion", (topic, message) -> {
        DatabaseService databaseService = DatabaseService.getInstance();
        System.out.println("Mensagem recebida de " + topic + ": " + message.toString());
        IDGRPC idgrpc = null;
        try {
        ...
        //TODO
    }), PRODUCT_CREATION_TOPIC("product/creation", (topic, message) -> {
        DatabaseService databaseService = DatabaseService.getInstance();
        System.out.println("Mensagem recebida de " + topic + ": " + message.toString());
        ...
        databaseService.listAll();
    }), PRODUCT_UPDATE_TOPIC("product/update", (topic, message) -> {
        DatabaseService databaseService = DatabaseService.getInstance();
        System.out.println("Mensagem recebida de " + topic + ": " + message.toString());
        ProductGRPC productGRPC = null;
        try {
    ...
    ), PRODUCT_DELETION_TOPIC("product/deletion", (topic, message) -> {
        DatabaseService databaseService = DatabaseService.getInstance();
        System.out.println("Mensagem recebida de " + topic + ": " + message.toString());
        IDGRPC idgrpc = null;
        try {
